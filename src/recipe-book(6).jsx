...
function getTheme(dark) {
  return dark ? {
    bg:"#15120D", surface:"#211D16", paper:"#2A2519", border:"#46402F",
    terra:"#F08A5D", terraBtn:"#A8511F", terraLight:"#3D2820", ink:"#FAF6EC", muted:"#C2B6A3",
    sage:"#A8CC9A", sageLight:"#27331F", white:"#2A2519", cream:"#15120D",
  } : {
    bg:"#FDFAF4", surface:"#FFFFFF", paper:"#F5EFE0", border:"#E8DEC8",
    terra:"#C4622D", terraBtn:"#C4622D", terraLight:"#F0D5C4", ink:"#2A2118", muted:"#6B5F4E",
        ...
        <div style={{padding:"16px 20px"}}>
          {tab==="user"&&<>
            <p style={{fontSize:13,color:T.muted,marginBottom:12,lineHeight:1.5}}>
              Send this recipe directly to another <em>gathered</em> user. It will appear in their inbox the next time they open the app.
            </p>
...
export default function App() {
  ...
  // Uses Groq (via gathered-api serverless function) for recipe extraction
  async function runImport(action) {
    ...
    setShowAdd(true);
    let userContent = null; // string OR array of {type, text/image_url} for vision
    ...
    try {
      if (action.type === "url") {
        ...
        // action.parts came from Claude-style {type, source/text} blocks
      ...
      // Step 2: call Groq via our serverless proxy
