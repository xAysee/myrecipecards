  ...
  if (bridge.is_new_signup) {
    ...
    if (error) {
      ...
      if (msg.includes("invalid login credentials") || msg.includes("email not confirmed")) {
        throw new Error("Login failed. Your account may not be confirmed yet. In Supabase go to Authentication > Configuration and disable Confirm Email, then try again.");
      }
      throw error;
    }
    await supabase.from("auth_bridge").update({
